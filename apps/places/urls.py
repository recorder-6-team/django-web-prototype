...
from .views import location_feature__management_aims
...
urlpatterns = [
  ...
  path('location-feature/<str:pk>/view/management-aims', location_feature__management_aims.LocationFeatureDetailManagementAimsView.as_view(), name='view--location-feature--management-aims'),
  ...
  path('location-feature/<str:pk>/update/management-aims', location_feature__management_aims.LocationFeatureUpdateManagementAimsView.as_view(), name='update--location-feature--management-aims'),
